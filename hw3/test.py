...
(X_train,Y_train), unlabeledX_train, (X_valid,Y_valid) = loading_Data(path)
#################Loading model#####################
...
###################################################
x_train = model.predict(X_train, batch_size=32)
x_valid = model.predict(X_valid, batch_size=32)
unlabeledx_train = model.predict(unlabeledX_train, batch_size=32)
y_train = np.argmax(Y_train, axis=1)
y_valid = np.argmax(Y_valid, axis=1)
x_test = model.predict(X_test, batch_size=32)
