...
if ('shallowSelf_model.json' in current_files):
  ########load json and create model#############
  json_file = open('shallowSelf_model.json', 'r')
...
if ('shallowSelf_model.h5' in current_files):  
  #######load weights into new model#########
  model.load_weights("shallowSelf_model.h5")
...
plt.savefig('shallowSelfAcc.png')
plt.show()
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('shallowSelfLoss.png')
plt.show()
