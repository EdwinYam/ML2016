...
path = '/home/MLfinal/Dataset/'

print 'Loading clicks_test.csv'
df_test = pd.read_csv(path + 'clicks_test.csv')

print 'Loading promoted_content.csv'
df_ad = pd.read_csv(path + 'promoted_content.csv',
    usecols  = ('ad_id','document_id'),
    dtype={'ad_id': np.int, 'uuid': np.str, 'document_id': np.str})

print 'Loading events.csv'
df_events = pd.read_csv(path + 'events.csv',
...
train = pd.read_csv(path + "clicks_train.csv")
